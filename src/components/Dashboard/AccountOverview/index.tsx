...
const AccountOverview = ({
  ...
  return (
    <div className="w-[1077px] h-[322px] rounded-[10px] bg-white flex items-center gap-5 p-6 ">
      <div className="w-1/2 h-full border border-gray2 rounded-md ">
        <h4 className="text-agro-black px-10 pt-4 h-14">ACCOUNT DETAILS</h4>
        <div className=" border-t border-t-gray2 py-10 px-10 ">
          <p className=" text-agro-green ">{name}</p>
          <p className="font-medium text-gray2 ">{email}</p>
        </div>
      </div>
      <div className="w-1/2 h-full border border-gray2 rounded-md overflow-clip ">
