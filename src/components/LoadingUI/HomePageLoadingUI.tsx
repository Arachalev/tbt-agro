...
const HomePageLoadingUI = () => {
  ...
  const cropProductsStyling = `gap-2 lg:gap-4 w-full grid grid-flow-col grid-rows-2`;
          ...
          return (
            <div key={getUniqueID()} className="">
              <Image
                ...
                alt=""
              />
              <div className="h-2 w-12 sm:w-10 bg-gray-300 mt-[6px] skeletonTexts" />
              <div className="h-2 w-10 sm:w-20 my-1 bg-gray-300 skeletonTexts" />

              <div className="h-2 w-16 sm:w-24 mb-1 bg-gray-200 skeletonTexts" />
              <div className="h-2 w-14 sm:w-24 bg-gray-300 skeletonTexts" />
            </div>
          );
        })}
      </div>
  ...
  return (
    <div className="m-auto grid justify-ceter justify-items-center md:grid-cols-4 gap-3 md:gap-5  w-full  2xl:w-[1400px] h-full">
